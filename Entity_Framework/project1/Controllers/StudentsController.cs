...
namespace project1.Controllers
{
    public class StudentsController : Controller
    {
       ...
       public async Task<IActionResult> Details(int? id)
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EditPost(int? Studentid)
        {
           ...
           // Console.WriteLine(id);
            ...
            var studentToUpdate = await _context.Students.FirstOrDefaultAsync(s => s.StudentID == Studentid);
        ...
        public async Task<IActionResult> DeleteConfirmed(int Studentid)
        {
            ...
            {
                //Log the error (uncomment ex variable name and write a log.)
                return RedirectToAction(nameof(Delete), new { id = Studentid, saveChangesError = true });
            }
        }
